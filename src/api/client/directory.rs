...
pub(crate) async fn get_public_rooms_filtered_route(
	SecureClientIp(ip): SecureClientIp, body: Ruma<get_public_rooms_filtered::v3::Request>,
...
pub(crate) async fn get_public_rooms_route(
	SecureClientIp(ip): SecureClientIp, body: Ruma<get_public_rooms::v3::Request>,
...
pub(crate) async fn set_room_visibility_route(
	SecureClientIp(ip): SecureClientIp, body: Ruma<set_room_visibility::v3::Request>,
