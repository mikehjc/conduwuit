...
pub(crate) async fn join_room_by_id_route(
	SecureClientIp(ip): SecureClientIp, body: Ruma<join_room_by_id::v3::Request>,
...
pub(crate) async fn join_room_by_id_or_alias_route(
	SecureClientIp(ip): SecureClientIp, body: Ruma<join_room_by_id_or_alias::v3::Request>,
...
pub(crate) async fn invite_user_route(
	SecureClientIp(ip): SecureClientIp, body: Ruma<invite_user::v3::Request>,
